...
![Agenda quirúrgica diaria de MeneQuiro. Fuente: elaboración propia.](img/AgendaMeneQuiro.png){#fig-manual-agenda width=95%}
...
![Propuestas automáticas de planificación. Fuente: elaboración propia.](img/ModuloSeleccion.png){#fig-manual-propuestas width=95%}
...
![Agenda tras añadir una nueva planificación. Fuente: elaboración propia.](img/Planificacion.png){#fig-manual-planificacion width=95%}
...
![Confirmación de una cirugía realizada. Fuente: elaboración propia.](img/ConfirmarCirugia.png){#fig-manual-confirmacion width=95%}
...
![Módulo de análisis de datos históricos. Fuente: elaboración propia.](img/EstadisticasQuirofano.png){#fig-manual-estadisticas width=95%}
...
![Exportación automática de la planificación en formato PDF. Fuente: elaboración propia.](img/PlanificacionPDF.png){#fig-manual-exportacion width=95%}
