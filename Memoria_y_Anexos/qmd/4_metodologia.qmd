...
La @tbl-normalizacion resume algunos ejemplos representativos del proceso de normalización realizado.

| Valor original | Valor utilizado finalmente |
|---|---|
...
: Ejemplos de normalización realizados durante el preprocesamiento. {#tbl-normalizacion}

Este proceso permitió reducir la dispersión artificial de los procedimientos, evitando que pequeñas diferencias de escritura generasen categorías estadísticas distintas. De este modo, el histórico pasó de ser un conjunto de registros administrativos a convertirse en una base de datos adecuada para el análisis estadístico y la recomendación de huecos quirúrgicos.
...
La duración media constituye el primer indicador empleado para caracterizar cada procedimiento y se calcula mediante la expresión mostrada en la Ecuación \ref{eq:media}.
