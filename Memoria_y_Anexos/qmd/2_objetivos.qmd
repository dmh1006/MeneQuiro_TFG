...
- Construir un catálogo quirúrgico basado en información histórica que permita caracterizar estadísticamente los distintos procedimientos realizados, siguiendo un enfoque basado en datos empleado habitualmente en la literatura sobre planificación quirúrgica [@cardoen2010; @guerriero2011].

- Desarrollar un algoritmo capaz de estimar la duración esperada de una intervención a partir del comportamiento observado en procedimientos similares, utilizando medidas estadísticas robustas [@james2021; @montgomery2020].

- Diseñar un sistema automático de recomendación de huecos quirúrgicos que proponga alternativas compatibles con la programación existente y minimice los tiempos muertos entre intervenciones, manteniendo la supervisión del planificador [@berner2007; @sutton2020].
...
- Implementar la aplicación utilizando Python como lenguaje principal de programación [@python2026].

- Diseñar una arquitectura modular que facilite el mantenimiento, escalabilidad y reutilización del software.

- Integrar herramientas de análisis y manipulación de datos mediante las bibliotecas Pandas y NumPy [@pandas2026; @numpy2026].

- Emplear una base de datos SQLite para el almacenamiento de la información generada durante la utilización de la herramienta [@sqlite2026].

- Desarrollar una interfaz gráfica interactiva mediante Streamlit que permita una utilización sencilla por parte del personal encargado de la planificación [@streamlit2026].
...
La @tbl-objetivos resume la relación entre los principales objetivos definidos y el resultado esperado dentro del desarrollo del proyecto.
...
: Resumen de objetivos del Trabajo Fin de Grado {#tbl-objetivos}