...
|---|---:|---:|---:|
| Análisis del problema y estudio del entorno hospitalario | 35 | 0 | 0 |
| Análisis, limpieza y normalización de datos | 70 | 0 | 0 |
| Estudio estadístico y construcción del catálogo quirúrgico | 55 | 0 | 0 |
| Desarrollo del algoritmo de recomendación | 65 | 0 | 0 |
| Desarrollo de la aplicación MeneQuiro | 120 | 0 | 0 |
| Implementación de exportaciones y base de datos | 35 | 0 | 0 |
| Validación funcional y corrección de errores | 45 | 0 | 0 |
| Elaboración de memoria y anexos | 80 | 0 | 0 |
| Reuniones, revisión y seguimiento del proyecto | 25 | 0 | 0 |
| Amortización del equipo informático | -- | -- | 0 |
| Recursos software empleados | -- | -- | 0 |
| **Total** | **530** | -- | **0** |

: Estimación económica del desarrollo del proyecto {#tbl-costes-proyecto}

Como se observa en la @tbl-costes-proyecto, el coste estimado del proyecto es de un total de **0 €**. 
