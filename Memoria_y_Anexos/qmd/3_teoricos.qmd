...
![Arquitectura general de MeneQuiro y relación entre sus principales módulos funcionales. Fuente: elaboración propia mediante inteligencia artificial generativa (OpenAI ChatGPT), revisada, validada y adaptada por el autor.](../img/Figura3.1.png){#fig-figura31 width=70%}
...
![Flujo general del proceso de planificación quirúrgica implementado en MeneQuiro. Fuente: elaboración propia mediante inteligencia artificial generativa (OpenAI ChatGPT), revisada, validada y adaptada por el autor.](../img/Figura3.2.png){#fig-figura32 width=70%}
...
![Esquema del algoritmo de recomendación automática de huecos quirúrgicos basado en datos históricos reales. Fuente: elaboración propia mediante inteligencia artificial generativa (OpenAI ChatGPT), revisada, validada y adaptada por el autor.](../img/Figura3.3.png){#fig-figura33 width=70%}
