...
La arquitectura tecnológica empleada para el desarrollo de MeneQuiro se presenta en la @fig-figura34, destacando la integración entre las diferentes herramientas utilizadas para el procesamiento de datos, el almacenamiento de información y la visualización de resultados.
